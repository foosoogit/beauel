...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::name('admin.')->group(function() {
        ...
        Route::post('admin/ajax_upsert_CashBookSmall',[AdminController::class,'ajax_upsert_CashBookSmall'])->name('ajax_upsert_CashBookSmall');
        Route::post('admin/ajax_upsert_CashBook',[AdminController::class,'ajax_upsert_CashBook'])->name('ajax_upsert_CashBook');
        Route::get('admin/CashBookRep_download',[AdminController::class,'CashBookRep_download'])->name('CashBookRep_download.get');
        Route::post('admin/CashBookRep_download',[AdminController::class,'CashBookRep_download'])->name('CashBookRep_download.post');
        
        Route::post('admin/CashBookSmallList', function () {
            if(null ===session('serch_payment_small_flg')){
                session(['serch_payment_small_flg' => "checked"]);
            }
            if (null ===session('serch_deposit_small_flg')){
                session(['serch_deposit_small_flg' => "checked"]);
            }
            if (null ===session('sort_key_cashbook_small')){
                session(['sort_key_cashbook_small' => "target_date"]);
            }
            if (null ===session('asc_desc_cashbook_small')){
                session(['asc_desc_cashbook_small' => "Desc"]);
            }
            session(['target_livewire_page' => "CashBooksmallList"]);
            return view('admin.CashBookSmallList');
        })->name('CashBookSmallList.post');
        Route::get('admin/CashBookSmallList', function () {
            if(null ===session('serch_payment_small_flg')){
                session(['serch_payment_small_flg' => "checked"]);
            }
            if (null ===session('serch_deposit_small_flg')){
        ...
        Route::get('/admin/deleteTreatmentContent/{serial_TreatmentContent}',[AdminController::class,'deleteTreatmentContent'],function($serial_TreatmentContent){})->name('deleteTreatmentContent.get');
    ...
    Route::controller(AdminController::class)->name('customers.')->group(function() {
        ...
        Route::get('/customers/ShowInpContract/{serial_user}', [AdminController::class,'ShowInpKeiyaku'],function($serial_user){})->name('ShowInpKeiyaku.get');
