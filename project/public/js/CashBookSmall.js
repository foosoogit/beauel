function payment_deposit_rdo_manage(obj){
  console.log("obj.id="+obj.id);
  if(obj.id=='transfer'){
    document.getElementById("summary").value="出納帳から入金";
  }else{
...
$('#CreateModal').on('hidden.bs.modal', function () {
  const element = document.getElementById("summary_slct");
  if (element) {
