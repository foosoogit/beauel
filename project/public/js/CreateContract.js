...
jQuery(document).ready(function($){
	$("#method_how_to_pay_slct").change(function(){
    	if(document.getElementById("method_how_to_pay_slct").value=="card"){
			console.log("method_how_to_pay_slct 3="+document.getElementById("method_how_to_pay_slct").value);
			document.getElementById("select_company").style.display="";
		}else{
			document.getElementById("select_company").style.display="none";
		}
	});
