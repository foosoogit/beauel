...
<div class="container-fluid">
	...
	{{--<div class="container text-center">--}}
        ...
        <iframe 
            ...
            width="100%" 
            id="sub_VisitHistory" 
            src="{{ route('customers.VisitHistory.get') }}"
            frameborder="0"
            allowfullscreen>
        </iframe>
    </div>
    ...
    <div class="col-md-6">
        <iframe 
            height="560" 
            width="100%" 
            id="sub_PaymentHistory" 
            src="{{ route('customers.PaymentHistory.get') }}"
            frameborder="0"
            allowfullscreen>
        </iframe>
    </div>
			{{-- 
			<div class="col">
				<iframe height="560" class="sub_VisitHistory pull-right" width="100%" id="sub_VisitHistory" onload="func_VisitHistory()" src="{{ route('customers.VisitHistory.get') }}"></iframe>
			</div>
			<div class="col">
				<iframe height="560" class="pull-left"  width="100%" id="sub_PaymentHistory" onload="func_PaymentHistory()" src="{{route('customers.PaymentHistory.get')}}"></iframe>
			</div>
			 --}}
		</div>
	{{--</div>--}}
<script>
	...
	function func_PaymentHistory() {
		console.log('PaymentHistoryの読み込み完了');
