                    ...
                    <form name="submitForm" id="submitForm">@csrf
                        <div class="modal-body">
                            ...
                            <div class="row p-2">
                                {{--
                                 <div class="col-auto">
                                    <label><input type="radio" name="payment_deposit_rdo" id="payment" onclick="payment_deposit_rdo_manage(this);" wire:model="payment_deposit_rdo" value='payment'>出金</label>
                                </div>
                                <div class="col-auto">
                                    <label><input type="radio" name="payment_deposit_rdo" id="deposit" onclick="payment_deposit_rdo_manage(this);" wire:model="payment_deposit_rdo" value='deposit'>入金</label>
                                </div>
                                <div class="col-auto">
                                    <label><input type="radio" name="payment_deposit_rdo" id="transfer" onclick="payment_deposit_rdo_manage(this);" wire:model="payment_deposit_rdo" value='payment'>小口出納帳へ</label>
                                </div>
                             --}}
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment_deposit_rdo" id="transfer" onclick="payment_deposit_rdo_manage(this);" wire:model="payment_deposit_rdo" value='payment'>
                                        <label class="form-check-label" for="transfer">小口現金へ</label>
                                    </div>
                                </div>
