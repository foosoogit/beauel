    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="pb-4 justify-content-center align-middle">
                ...
                --}}
                <div class="mb-2 bg-success text-white"><span class="border border-success bg-success text-white rounded h5">&nbsp;{{session('target_branch_name')}}&nbsp;</span>&nbsp;&nbsp;施術登録リスト</div>
                                ...
                                @foreach ($treatment_contents as $treatment_content)
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2" style="text-align: left;">
                                            {{-- <formaction="/admin/deleteTreatmentContent/$treatment_content->serial_treatment_contents" method="GET">@csrf--}}
                                            <form action="{{ route('admin.deleteTreatmentContent.get', $treatment_content->serial_treatment_contents) }}" method="GET">@csrf
