<div>
    <div class="container text-center">
		...
		<div class="mb-2 bg-secondary text-white"><span class="border border-success bg-success text-white rounded h5">&nbsp;{{session('target_branch_name')}}&nbsp;</span>&nbsp;&nbsp;スタッフ一覧</div>
		<div class="row">
			<div class="col-auto">
				...
				<thead>
					<tr>
						<th class="border px-4 py-2">スタッフデータ修正<br>
							<button type="button" wire:click="sort('serial_staff-ASC')"><img src="{{ asset('/images/sort_A_Z.png') }}" width="15px"/></button>
							<button type="button" wire:click="sort('serial_staff-Desc')"><img src="{{ asset('/images/sort_Z_A.png') }}" width="15px" /></button></th>
						<th class="border px-4 py-2">氏名
							<button type="button" wire:click="sort('last_name_kanji-ASC')"><img src="{{ asset('images/sort_A_Z.png') }}" width="15px" /></button>
							<button type="button" wire:click="sort('last_name_kanji-Desc')"><img src="{{ asset('images/sort_Z_A.png') }}" width="15px" /></button></th>
						<th class="border px-4 py-2">しめい
							...
							<button type="button" wire:click="sort('last_name_kana-Desc')"><img src="{{ asset('images/sort_Z_A.png') }}" width="15px" /></button></th>
						<th class="border px-4 py-2">生年月日
							<button type="button" wire:click="sort('birth_date-ASC')"><img src="{{ asset('images/sort_A_Z.png') }}" width="15px" /></button>
							<button type="button" wire:click="sort('birth_date-Desc')"><img src="{{ asset('images/sort_Z_A.png') }}" width="15px" /></button></th>
						<th class="border px-4 py-2">電話番号
							<button type="button" wire:click="sort('phone-ASC')"><img src="{{ asset('images/sort_A_Z.png') }}" width="15px" /></button>
							<button type="button" wire:click="sort('phone-Desc')"><img src="{{ asset('images/sort_Z_A.png') }}" width="15px" /></button></th>
						<th class="border px-4 py-2">メールアドレス
							<button type="button" wire:click="sort('email-ASC')"><img src="{{ asset('images/sort_A_Z.png') }}" width="15px" /></button>
							<button type="button" wire:click="sort('email-Desc')"><img src="{{ asset('images/sort_Z_A.png') }}" width="15px" /></button>
						</th>
						<th class="border px-4 py-2">店舗
							<button type="button" wire:click="sort('branch-ASC')"><img src="{{ asset('images/sort_A_Z.png') }}" width="15px" /></button>
							<button type="button" wire:click="sort('branch-Desc')"><img src="{{ asset('images/sort_Z_A.png') }}" width="15px" /></button>
						</th>
				...
				<tbody>
					@foreach ($staffs as $staff)
						<tr>
							...
							<td class="border px-4 py-2">{{ $staff->BrachName}}</td>
