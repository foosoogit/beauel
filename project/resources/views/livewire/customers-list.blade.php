    ...
    <div class="py-12 row justify-content-center">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="pb-4 align-middle">
                ...
                <div class="mb-2 bg-secondary text-white"><span class="border border-success bg-success text-white rounded h5">&nbsp;{{session('target_branch_name')}}&nbsp;</span>&nbsp;&nbsp;顧客一覧</div>
                        ...
                        <tr>
                            <th class="border px-4 py-2">顧客データ修正
                                <div class="text-nowrap">
                                    <button type="button" wire:click="sort('serial_user-ASC')"><img src="{{asset('images/sort_A_Z.png')}}" width="15px" /></button>
                                    <button type="button" wire:click="sort('serial_user-Desc')"><img src="{{asset('images/sort_Z_A.png')}}" width="15px" /></button>
                                </div>
                            </th>
                            ...
                            <th class="border px-4 py-2">
                                <div class="text-nowrap">氏名
                                    <button type="button" wire:click="sort('name_sei-ASC')"> <img src="{{asset('images/sort_A_Z.png')}}" width="15px" /></button>
                                    <button type="button" wire:click="sort('name_sei-Desc')"> <img src="{{asset('images/sort_Z_A.png')}}" width="15px" /></button>
                                </div>
                            </th>
                            <th class="border px-4 py-2">
                                <div class="text-nowrap">しめい
                                    <button type="button" wire:click="sort('name_sei_kana-ASC')"> <img src="{{asset('images/sort_A_Z.png')}}" width="15px" /></button>
                                    <button type="button" wire:click="sort('name_sei_kana-Desc')"> <img src="{{asset('images/sort_Z_A.png')}}" width="15px" /></button>
                                </div>
                            </th>
                            {{-- 
                            <th class="border px-4 py-2">
                                <div class="text-nowrap">残金
                                    <button type="button" wire:click="sort('zankin-ASC')"> <img src="{{asset('images/sort_A_Z.png')}}" width="15px" /></button>
                                    <button type="button" wire:click="sort('zankin-Desc')"> <img src="{{asset('images/sort_Z_A.pngimages/sort_A_Z.png')}}" width="15px" /></button>
                                </div>
                                <div class="text-nowrap">
                            ...
                            <th class="border px-4 py-2">
                                <div class="text-nowrap">生年月日
                                    <button type="button" wire:click="sort('birth_year-ASC')"> <img src="{{asset('images/sort_A_Z.png')}}" width="15px" /></button>
                                    <button type="button" wire:click="sort('birth_year-Desc')"> <img src="{{asset('images/sort_Z_A.png')}}" width="15px" /></button>
                                </div>
                            </th>
                            <th class="border px-4 py-2">
                            ...
                            <th class="border px-4 py-2">予約日入力
                                <div>
                                    ...
                                    <button type="button" wire:click="sort('yoyaku-Desc')"><img src="{{asset('images/sort_Z_A.png')}}" width="15px" disabled/></button>
                                </div>
                            </th>
                                ...
                                <td class="border px-4 py-2">
                                   ...
                                   {{--  @if(session('target_branch_serial')==="01")--}}
                                    {{--<form action="/customers/ContractList/{{$user->serial_user}}" method="GET">@csrf<input name="keiyaku_Btn" type="submit" value="履歴・新規">--}}
                                        <form action="{{ route('customers.ContractList.get', ['UserSerial' => $user->serial_user]) }}" method="GET">@csrf<input name="keiyaku_Btn" type="submit" value="履歴・新規">
